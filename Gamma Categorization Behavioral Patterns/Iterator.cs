...
{
    // An iterator is a class that facilitates the traversal, it's a core functionality of various data structures, it's an implicit construct ( around your yield return )
    // An iterator object, cannot be recursive
    // Generally, an IEnumerable<T> returning method is enough, works on duck typing( you need a GetEnumerator() that yields a type that has a Current and MoveNext() )
    public class Node<T>
    {
        public T Value;
