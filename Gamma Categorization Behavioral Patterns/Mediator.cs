...
{
    // Facilitates the communication between components without them necessarily being aware of each otehr or having direct access to each other
    // Create the mediator and have each object in the system refer to it 
    // Mediator engages in bidirectional communication with its connected components, has function the components can call
    // Event processing libraries make communication eassier to implement ( React )
    public class Person
    {
        public string Name;
