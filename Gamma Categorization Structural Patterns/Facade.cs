...
namespace Gamma_Categorization_Structural_Patterns
{
    ...
    // Many systems working to provide flexibility, API consumers want it to 'just work'
    // def -> Provides a simple, easy to understand/user interface over a large and sophisticated body of code
    // Build a Facade to provide a simplified API over a set of classes
    // May wish to expose internals through the facade
...
{
    using Gamma_Categorization_Structural_Patterns;
